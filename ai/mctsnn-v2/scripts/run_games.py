...
AGENT_0 = {
    ...
    "type": "mcts",
    "evaluator": "network",
    "checkpoint": "ai/mctsnn-v2/data/checkpoints/run_20260710_193515_gated_cap10/gen074.pt",
    "n_sims": 400,
    "c_puct": 1.5,
    "add_noise": False,
    "temperature": 0.0,
...
N_GAMES     = 3          # how many games to play
TURN_LIMIT  = 10          # max turns before a game is called (turn cap -> heuristic outcome)
BASE_SEED   = 12345678      # game i uses map seed BASE_SEED + i
