...
AGENT_0 = {
    ...
    "type": "mcts",
    "evaluator": "network",
    "checkpoint": "ai/mctsnn-v2/data/checkpoints/run_20260708_234813_guards/gen003.pt",
    "n_sims": 250,
    "c_puct": 1.5,
    "add_noise": False,
    "temperature": 0.0,
...
AGENT_1 = {
    ...
    "type": "mcts",
    "evaluator": "network",
    "checkpoint": "ai/mctsnn-v2/data/checkpoints/run_20260709_132843_guards/gen003.pt",
    "n_sims": 250,
    "c_puct": 1.5,
    "add_noise": False,
    "temperature": 0.0,
...
BASE_SEED   = 6969       # game i uses map seed BASE_SEED + i
